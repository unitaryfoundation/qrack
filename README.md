...
**Firstly, are you looking for the applications promised by quantum computing?** Do you want to run tens of thousands of nodes or more of _transverse field Ising model (TFIM),_ or _quadratic unconstrained binary optimization (QUBO)_ in the form of _MAXCUT,_ or the _Traveling Salesman Problem (TSP),_ at quality and scaling performance beyond _quantum annealers,_ _VQE,_ and _QAOA,_ at the scale of a consumer laptop, with _"quantum-inspired"_ heuristics? Then, **Qrack** will do a lot of things, but you likely want [PyQrackIsing](https://github.com/vm6502q/PyQrackIsing) for that. (Also, see the [examples repository](https://github.com/vm6502q/pyqrack-examples) for self-contained laptop-scale demonstrations of some of our best performance cases on "quantum supremacy" and "quantum advantage" benchmarks.) Otherwise, we'll tell you how to get started with **Qrack**.
