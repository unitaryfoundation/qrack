...
public:
    ...
    /**
     * Set major vs. minor S-gate quadrant default for subsequent closest Clifford state
     */
    virtual void SetMajorQuadrant(bool q) {}
    /**
     * Set major vs. minor S-gate quadrant for closest Clifford state on specific qubit
     */
